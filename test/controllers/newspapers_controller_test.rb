...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference("Newspaper.count") do
      post newspapers_url, params: { newspaper: { language: @newspaper.language, name: @newspaper.name, url: @newspaper.url } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { language: @newspaper.language, name: @newspaper.name, url: @newspaper.url } }
