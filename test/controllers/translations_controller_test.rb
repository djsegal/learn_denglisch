...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { input_message: @translation.input_message, language: @translation.language, output_message: @translation.output_message } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { input_message: @translation.input_message, language: @translation.language, output_message: @translation.output_message } }
